from vid_configuration import YOLO_CONFIG, VIDEO_CONFIG, SHOW_PROCESSING_OUTPUT, DATA_RECORD_RATE, FRAME_SIZE, TRACK_MAX_AGE
...
import csv
import json
from video_process_helper import video_process
...
crowd_data_file = open('static/crowd_data.csv', 'w')
